...
### Phase 2 — 완성도
- [x] 요청 파라미터/바디 템플릿 (`${int(1,20)}` 등, 경로·쿼리·바디 + 어노테이션 기본값 + UI 미리보기)
- [x] 테스트 히스토리 저장/비교 (JSON 파일 저장, 직전 run 자동 델타, 두 run 비교 뷰)
- [~] README + 사용 예제 데모 앱 (README에 템플릿·히스토리·설정 표 반영, 스크린샷/예제 보강 남음)
